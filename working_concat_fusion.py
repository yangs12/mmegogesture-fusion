...
class FloatInputFusionClassifier(nn.Module):
    def __init__(self, num_classes,dropout=True, batchnorm=True):
        super().__init__()
...
fusion_classifier = FloatInputFusionClassifier(NUM_CLASSES).to(DEVICE)
