...
class RadarConfig(OrderedDict):
    ...
    def get_params(self):
        ...
        chirp_time *= n_tx
        velocity_max = (3e8/(operating_freq*1e9))/(4*(chirp_time*1e-6))   # Units in m/sec
        velocity_res = 2*velocity_max/n_chirps                            # Units in m/sec
